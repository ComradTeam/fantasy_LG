...
function PANEL:Init()
	...
	-- ❌ УДАЛЕНО: logoPanel (это и была плашка)
...
object-fit:cover;
">
<source src="https://comradteam.github.io/fantasy_LG/bg.webm" type="video/webm">
</video>
</body>
</html>
]])

self.videoBackground:SetMouseInputEnabled(false)
self.videoBackground:SetKeyboardInputEnabled(false)
self.videoBackground:MoveToBack()
