...
function ix.db.LoadTables()
	...
	query = mysql:Create("ix_characters_data")
		query:Create("entry", "INT(11) UNSIGNED NOT NULL AUTO_INCREMENT")
		query:Create("id", "INT(11) UNSIGNED NOT NULL")
		query:Create("data", "TEXT NOT NULL")
		query:Create("key", "TEXT NOT NULL")
		query:PrimaryKey("entry")
	query:Execute()

	query = mysql:Create("ix_datapad")
		query:Create("update_id", "INT(11) UNSIGNED NOT NULL AUTO_INCREMENT")
		query:Create("update_text", "TEXT NOT NULL")
		query:Create("update_date", "TEXT NOT NULL")
		query:Create("update_poster", "TEXT NOT NULL")
